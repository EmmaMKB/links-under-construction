...
<html lang="en">
    <head>
        ...
        <title>Links Logistics and Services :: Website Coming soon</title>
        <link rel="shortcut icon" href="{{ asset('assets/favicon.png') }}" />
        <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,600|Raleway:300,400" rel="stylesheet" />
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/asf2525xljt.css') }}" />
    </head>
    <body>
        <div id="main">
            <div id="page-loader">
            ...
            <section id="hero" class="hero hero-1">
                <div class="front-content page-enter-animated">
                    <div class="container-mid">
                        <img class="logo" src="{{ asset('assets/images/logo_white.png') }}" alt="Links Logistics Logo" />
                        <div class="cycle-wrapper">
                            <div id="cycle">
                                <div class="slide">
                                    <h1>
                                        Getting extra <span> miles </span><br />
                                        to serve you<br />
                                        better.
                                    </h1>
                                </div>
        ...
        <script type="text/javascript" src="{{ asset('assets/js/xsg235t4r1r.js') }}"></script>
    </body>
</html>
